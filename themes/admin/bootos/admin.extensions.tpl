...
<div style="clear:left; height:40px; padding-top:5px;">
  ...
  <!-- IF !{PHP.isinstalled} -->
    <a title="{PHP.L.adm_opt_install_explain}" href="{ADMIN_EXTENSIONS_INSTALL_URL}" class="btn btn-large btn-success"><i class="icon-ok icon-white"></i> {PHP.L.adm_opt_install}</a>
  <!-- ELSE -->
    <!-- IF {PHP.exists} -->
...
<table class="table table-conden table-striped">
  <thead>
    <tr>
      <th>{PHP.L.Name}</th>
    ...
    <tr>
      ...
      <td>
        ...
        <div class="btn-group">
          ...
          <!-- IF {PHP.ifthistools} -->
          <a class="btn btn-mini btn-warning" title="{PHP.L.Administration}" href="{ADMIN_EXTENSIONS_JUMPTO_URL_TOOLS}"><i class="icon-wrench"></i></a>
          <!-- ELSE -->
          <a class="btn btn-mini btn-warning disabled"><i class="icon-wrench"></i></a>
          <!-- ENDIF -->
        </div>
        <!-- ENDIF -->
      </td>
